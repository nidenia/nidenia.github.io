...
var _loop = function _loop(i) {
  var tab = tabs[i];
  var tabsItems = tab.querySelectorAll('._tabs-item');
  var tabsBlocks = tab.querySelectorAll('._tabs-block');

  var _loop2 = function _loop2(_i) {
    var tabsItem = tabsItems[_i];
    tabsItem.addEventListener('click', function () {
      for (var _i2 = 0; _i2 < tabsItems.length; _i2++) {
        var _tabsItem = tabsItems[_i2];

        _tabsItem.classList.remove('_active');

        tabsBlocks[_i2].classList.remove('_active');
      }

      tabsItem.classList.add('_active');

      tabsBlocks[_i].classList.add('_active');
    });
  };

  for (var _i = 0; _i < tabsItems.length; _i++) {
    _loop2(_i);
  }
};
...
// EXTERNAL MODULE: ./js/helpers/tabs.js
var tabs = __webpack_require__(252);
// EXTERNAL MODULE: ./js/helpers/swiper-min.js
var swiper_min = __webpack_require__(319);
var swiper_min_default = /*#__PURE__*/__webpack_require__.n(swiper_min);
// EXTERNAL MODULE: ./js/helpers/spoiler.js
var spoiler = __webpack_require__(150);
...
document.addEventListener('DOMContentLoaded', function () {
  var burger = document.querySelector('.menu__burger-wrapper');
  var menuBody = document.querySelector('.menu__body');
  var subscribeButton = document.querySelector('.menu__link--subscribe');
...
var clients = new (swiper_min_default())('.lead__slider', {
  loop: true,
  slidesPerView: 1,
  speed: 800,
  preloadImages: false,
...
;// CONCATENATED MODULE: ./js/subscribe.js

document.addEventListener('DOMContentLoaded', function () {
  var form = document.querySelector('.form');
  var warning = document.querySelector('.form__warning');
  var formSubmitBtn = document.querySelector('.form__button');
